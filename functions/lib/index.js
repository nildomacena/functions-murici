...
exports.atualizaImagensCriadas = functions.storage.object().onFinalize((object, context) => {
...
exports.atualizaImagensAtualizadas = functions.storage.object().onMetadataUpdate((object, context) => {
    const bucket = admin.storage().bucket("tradegames-2dff6.appspot.com");
    return bucket.file(object.name).getSignedUrl({ action: 'read', expires: '03-09-2491' })
        .then(url => {
        console.log('url: ', url[0]);
